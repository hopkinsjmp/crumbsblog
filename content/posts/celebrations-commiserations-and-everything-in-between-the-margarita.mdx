...
method: |-
  1.  Firstly, pour out some flaked salt onto a small plate or saucer. I usually bash the salt briefly in a pestle and mortar so that it’s a little finer. But it’s totally down to preference. Fine salt can also be used (see intro).
